...
namespace MVCDemoAppCS.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderId,ProductId,Quantity,Rate")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderId,ProductId,Quantity,Rate")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
