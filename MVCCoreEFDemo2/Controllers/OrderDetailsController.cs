...
namespace MVCCoreEFDemo2.Controllers
{
    public class OrderDetailsController : Controller
    {
        private readonly BusinessDBContext _context;

        public OrderDetailsController(BusinessDBContext context)
        {
            _context = context;
        }
        ...
        {
            var businessDBContext = _context.OrderDetail.Include(o => o.Order).Include(o => o.Product);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,ProductId,Quantity,Rate")] OrderDetail orderDetail)
        {
