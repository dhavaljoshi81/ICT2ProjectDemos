...
namespace OrderManagementWebAPICS.Models
{
    public partial class BusinessDBContext : DbContext
    {
        ...
        public virtual DbSet<ActionFilterEntry> ActionFilterEntry { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //optionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=G:\\ICT22020\\AngularNETCoreDemoProjCS\\OrderManagementWebAPICS\\App_Data\\BusinessDB.mdf;Integrated Security=True;Trusted_Connection=True;");
            }
        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ActionFilterEntry>(entity =>
            {
